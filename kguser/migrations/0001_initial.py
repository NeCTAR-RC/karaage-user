...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectRenamed'
        db.create_table(u'kguser_projectrenamed', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
            ('renamed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'kguser', ['ProjectRenamed'])


    def backwards(self, orm):
        # Deleting model 'ProjectRenamed'
        db.delete_table(u'kguser_projectrenamed')
    ...
    models = {
        ...
        u'kguser.projectrenamed': {
            'Meta': {'object_name': 'ProjectRenamed'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.Project']"}),
            'renamed': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'people.group': {
        ...
        u'projects.project': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 6, 0, 0)'})
        }
    }
